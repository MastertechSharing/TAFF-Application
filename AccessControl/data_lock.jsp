...
<% 
	...
	session.setAttribute("action", "data_lock.jsp?action="+getaction+"&");
...
<html lang="en">
	<head>
		...
		<script type="text/javascript">
			...
			function Confirm_Button(){
				location.href = 'module/act_lock.jsp?action=clear&day_type='+document.getElementById('sCode').value;
			}
		</script>
	</head>
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="Clear_Session_Table('<%= clear_session %>', 'DataTables_data_table_<%= request.getRequestURI() %>'); Load_DataTable();">
				...
				<div class="table-responsive" style="border: 0px !important;" border="0">
					...
					<div style="min-width: 800px;" class="table" border="0">	
						...
						<table style="min-width: 800px;" align="center" id="data_table" class="table table-striped table-bordered" cellspacing="0" >
							...
							<%	
								try{
									ResultSet rs = stmtQry.executeQuery("SELECT * FROM dblock ORDER BY day_type ASC");
									while(rs.next()){
							...
							<%	if(checkPermission(ses_per, "01")){	%>
									<td align="center"> 
										<a href="edit_lock.jsp?action=edit&day_type=<%= day_type %>"> <img src="images/edit.png" width="18" height="18" border="0" align="absmiddle" data-toggle="tooltip" data-placement="right" title="<%= lb_editdata %>"> </a>
									</td>
									<td align="center"> 
		...
		function show_detail(day_type){
			view_detail_220px.location = 'view_lock.jsp?action=view&day_type='+day_type;
