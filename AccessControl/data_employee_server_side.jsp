		...
		try{
			...
			while (rs.next()) {				
				...
				if(checkPermission(ses_per, "0135")){
					...
					ja.put("<center> <img src='images/"+img_jpg+"' width='18' height='18' border='0' align='absmiddle' onClick='browsePhotos(\""+lb_emp_photo+"\", \""+idcard+"\");' data-toggle='tooltip' data-placement='right' data-html='true' title='"+lb_emp_photo+"'> </center>");	//	onLoad='chkPhoto(\""+idcard+"\");'  id='img_"+idcard+"'
