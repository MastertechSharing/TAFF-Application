...
<% 
	...
	session.setAttribute("subtitle", "report_106");
	session.setAttribute("action", "report_106.jsp?");
									...
									<div class="bs-callout bs-callout-info"> 
										...
										<div class="row">
											...
											<div class="modal-title col-xs-6 col-md-6" align="right">
												...
												<input type="hidden" id="time1" name="time1" value="00:00">
												<input type="hidden" id="time2" name="time2" value="23:59">
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_106_excel.jsp";
				}
