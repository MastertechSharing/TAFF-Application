...
<% 
	...
	session.setAttribute("action", "edit_door.jsp?"+"&action="+request.getParameter("action")+"&door_id="+request.getParameter("door_id")+"&");
%>
...
<html lang="en">
	<head>
		...
		<script language="javascript">
			...
			function ConfirmAddEdit(act, sText, sText2, ip, sText3, sText4, sText5, sText6, sText7, sText8){	
				...
				if(document.form1.compare_mode.value == "a"){
					ModalWarning_TextName(sText5, 'compare_mode');
					return false;
				}
				if(document.form1.door_lock.value == "a"){
					ModalWarning_TextName(sText6, 'door_lock');
					return false;
				}
				if(document.form1.alarm_door.value == "a"){
					ModalWarning_TextName(sText7, 'alarm_door');
					return false;
				}
				if(document.form1.alarm_time.value == "a"){
					ModalWarning_TextName(sText8, 'alarm_time');
					return false;
				}
				if(act == 'add'){
					document.form1.action = "module/act_door.jsp?action=add&";
			...
			function Confirm_Button(){
				document.form1.action = "module/act_door.jsp?action=edit&";
				document.getElementById("form1").submit();
			}
			
		/* 	function chkreadSerail(){
				if(form1.compare_mode.value != 0){
					document.getElementById('serailcard').checked = false;	
					form1.compare_mode.focus();
				//	return false;
				}
			}
			
			function chkSerail_card(){
				if(form1.compare_mode.value == 0){
					document.getElementById('serailcard').checked = true;
				}else{
					document.getElementById('serailcard').checked = false;		
				}
			}
...
%>						
			...
			%>
					...
					<div class="row form-group">
						<label class="control-label label-text-1 col-md-3"> <%= lb_comparemode %> : </label>
						<div class="col-md-3">
							<select class="form-control selectpicker" data-width="100%" data-size="10" name="compare_mode" id="compare_mode">
								<option value="0"> <%= displayCompareMode("0") %> </option>
								<option value="1"> <%= displayCompareMode("1") %> </option>
								<option value="2"> <%= displayCompareMode("2") %> </option>
								<option value="3"> <%= displayCompareMode("3") %> </option>
							</select>
						</div>
						<div class="col-md-6" style="margin-top: 6px;">
							<input name="serailcard" type="checkbox" id="serailcard" value="serailcard" style="margin-right: 10px;"> <%= lb_read_serialcard %>
						</div>
					</div> 
					...
					<div class="row col-md-6" style="margin-top: 0px; margin-left: 0px; margin-right: -20px">
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_doorrelease %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="door_lock" id="door_lock">
						<%		String loop1;
								for(int i = 0; i <= 99; i++){
									if(i < 10) loop1 = "0" + i; else loop1 = Integer.toString(i);
						%>
									<option value="<%= loop1 %>" <%= checkDataSelected(loop1, "05") %>> <%= loop1 %> </option>
						<%		}	%>
								</select>
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_alarmafter %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="alarm_door" id="alarm_door">
						<%		String loop2;
								for(int i = 0; i <= 99; i++){
									if(i < 10) loop2 = "0" + i; else loop2 = Integer.toString(i);
						%>
									<option value="<%= loop2 %>" <%= checkDataSelected(loop2, "15") %>> <%= loop2 %> </option>
						<%		}	%>
								</select>
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_alarmduration %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="alarm_time" id="alarm_time">
						<%		String loop3;
								for(int i = 0; i <= 99; i++){
									if(i < 10) loop3 = "0" + i; else loop3 = Integer.toString(i);
						%>
									<option value="<%= loop3 %>" <%= checkDataSelected(loop3, "99") %>> <%= loop3 %> </option>
						<%		}	%>
								</select>
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout2 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout2" id="timeoffout2">
						<%		String time_offout2;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout2 = "0" + i; else time_offout2 = Integer.toString(i);		
						%>
									<option value="<%= time_offout2 %>" <%= checkDataSelected(time_offout2, "05") %>> <%= time_offout2 %> </option>
						<%		}	%>
								</select>
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout3 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout3" id="timeoffout3">
						<%		String time_offout3;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout3 = "0" + i; else time_offout3 = Integer.toString(i);		
						%>
									<option value="<%= time_offout3 %>" <%= checkDataSelected(time_offout3, "05") %>> <%= time_offout3 %> </option>
						<%		}	%>
								</select>
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout4 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout4" id="timeoffout4">
						<%		String time_offout4;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout4 = "0" + i; else time_offout4 = Integer.toString(i);		
						%>
									<option value="<%= time_offout4 %>" <%= checkDataSelected(time_offout4, "05") %>> <%= time_offout4 %> </option>
						<%		}	%>
								</select>
							</div>
						</div> 
					...
					<div class="row col-md-6" style="margin-top: 0px; margin-left: 0px; margin-right: -20px">
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout1e37 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout1e37" id="timeoffout1e37">
						<%		String time_offout1e37;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout1e37 = "0" + i; else time_offout1e37 = Integer.toString(i);	
						%>
									<option value="<%= time_offout1e37 %>" <%= checkDataSelected(time_offout1e37, "05") %>> <%= time_offout1e37 %> </option>
						<%		}	%>
								</select>
							</div>
						</div>
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout2e37 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout2e37" id="timeoffout2e37">
						<%		String time_offout2e37;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout2e37 = "0" + i; else time_offout2e37 = Integer.toString(i);	
						%>
									<option value="<%= time_offout2e37 %>" <%= checkDataSelected(time_offout2e37, "05") %>> <%= time_offout2e37 %> </option>
						<%		}	%>
								</select>
							</div>
						</div>
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout1e39 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout1e39" id="timeoffout1e39">
						<%		String time_offout1e39;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout1e39 = "0" + i; else time_offout1e39 = Integer.toString(i);	
						%>
									<option value="<%= time_offout1e39 %>" <%= checkDataSelected(time_offout1e39, "05") %>> <%= time_offout1e39 %> </option>
						<%		}	%>
								</select>
							</div>
						</div>
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout2e39 %> : </label>
							<div class="col-md-6">
								<select class="form-control selectpicker" data-width="101%" data-size="10" name="timeoffout2e39" id="timeoffout2e39">
						<%		String time_offout2e39;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout2e39 = "0" + i; else time_offout2e39 = Integer.toString(i);	
						%>
									<option value="<%= time_offout2e39 %>" <%= checkDataSelected(time_offout2e39, "05") %>> <%= time_offout2e39 %> </option>
						<%		}	%>
								</select>
							</div>
						</div>
						...
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-12" style="font-size: 12px; font-style: normal;color: #F95450;"> 
								** <%= lb_comment %> : ( 00 = <%= lb_notwork %>, 99 = <%= lb_alwaywork %> )
							</label>
						</div>
					</div>
					...
					<div class="row form-group" style="margin-bottom: 0px;">
						<div class="col-md-12" align="center"> 
							...
							<input type="button" class="btn btn-primary btn-sm button-shadow1 button-shadow2" id="btnok" value=" &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; " onClick="return ConfirmAddEdit('add', '<%= msg_confirmedit %>', '<%= msg_notinputdoor %>', '<%= msg_sethostip %>', '<%= msg_notinputlocat %>', '<%= msg_set_doorid %>', '<%= msg_comparemode %>', '<%= msg_doorlock %>', '<%= msg_alarmdoor %>', '<%= msg_doorlock %>');"> &nbsp; 
							<input type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" value=" &nbsp; &nbsp; &nbsp; <%= btn_cancel %> &nbsp; &nbsp; &nbsp; " onClick="location.href='data_door.jsp'">
						</div>
					</div> 
...
%>
				...
				<%  			}	rs_location.close();		%>
					...
					<div class="row form-group">
						...
						<div class="col-md-3">
							<select class="form-control selectpicker" data-width="100%" data-size="10" name="compare_mode" id="compare_mode">
								<option value="0" <%= checkDataSelected(compare_mode, "0") %>> <%= displayCompareMode("0") %> </option>
								<option value="1" <%= checkDataSelected(compare_mode, "1") %>> <%= displayCompareMode("1") %> </option>
								<option value="2" <%= checkDataSelected(compare_mode, "2") %>> <%= displayCompareMode("2") %> </option>
								<option value="3" <%= checkDataSelected(compare_mode, "3") %>> <%= displayCompareMode("3") %> </option>
							</select>
							<input type="hidden" id="oldcomp_mode" name="oldcomp_mode" value="<%= compare_mode %>">
						</div>
						<div class="col-md-6" style="margin-top: 6px;">
							<input name="serailcard" type="checkbox" id="serailcard" value="serailcard" style="margin-right: 10px;" <%= checkBoxAtPos(serail_card, 0) %>> <%= lb_read_serialcard %>
						</div>
					</div> 
					...
					<div class="row col-md-6" style="margin-top: 0px; margin-left: 0px; margin-right: -20px">
						...
						<%		String loop1;
								for(int i = 0; i <= 99; i++){
									if(i < 10) loop1 = "0" + i; else loop1 = Integer.toString(i);
						%>
									<option value="<%= loop1 %>" <%= checkDataSelected(loop1, door_lock) %>> <%= loop1 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="olddoorlock" value="<%= door_lock %>">	
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_alarmafter %> : </label>
						...
						<%		String loop2;
								for(int i = 0; i <= 99; i++){
									if(i < 10) loop2 = "0" + i; else loop2 = Integer.toString(i);
						%>
									<option value="<%= loop2 %>" <%= checkDataSelected(loop2, alarm_door) %>> <%= loop2 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldalarmdoor" value="<%= alarm_door %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_alarmduration %> : </label>
						...
						<%		String loop3;
								for(int i = 0; i <= 99; i++){
									if(i < 10) loop3 = "0" + i; else loop3 = Integer.toString(i);
						%>
									<option value="<%= loop3 %>" <%= checkDataSelected(loop3, alarm_time) %>> <%= loop3 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldalarmtime" value="<%= alarm_time %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout2 %> : </label>
						...
						<%		String time_offout2;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout2 = "0" + i; else time_offout2 = Integer.toString(i);		
						%>
									<option value="<%= time_offout2 %>" <%= checkDataSelected(time_offout2, timeoffout2) %>> <%= time_offout2 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout2" value="<%= timeoffout2 %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout3 %> : </label>
						...
						<%		String time_offout3;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout3 = "0" + i; else time_offout3 = Integer.toString(i);		
						%>
									<option value="<%= time_offout3 %>" <%= checkDataSelected(time_offout3, timeoffout3) %>> <%= time_offout3 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout3" value="<%= timeoffout3 %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout4 %> : </label>
						...
						<%		String time_offout4;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout4 = "0" + i; else time_offout4 = Integer.toString(i);		
						%>
									<option value="<%= time_offout4 %>" <%= checkDataSelected(time_offout4, timeoffout4) %>> <%= time_offout4 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout4" value="<%= timeoffout4 %>">
							</div>
						</div> 
					</div>
					...
					<div class="row col-md-6" style="margin-top: 0px; margin-left: 0px; margin-right: -20px">
						...
						<%		String time_offout1e37;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout1e37 = "0" + i; else time_offout1e37 = Integer.toString(i);	
						%>
									<option value="<%= time_offout1e37 %>" <%= checkDataSelected(time_offout1e37, timeoffout1e37) %>> <%= time_offout1e37 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout1e37" value="<%= timeoffout1e37 %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout2e37 %> : </label>
						...
						<%		String time_offout2e37;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout2e37 = "0" + i; else time_offout2e37 = Integer.toString(i);	
						%>
									<option value="<%= time_offout2e37 %>" <%= checkDataSelected(time_offout2e37, timeoffout2e37) %>> <%= time_offout2e37 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout2e37" value="<%= timeoffout2e37 %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout1e39 %> : </label>
						...
						<%		String time_offout1e39;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout1e39 = "0" + i; else time_offout1e39 = Integer.toString(i);	
						%>
									<option value="<%= time_offout1e39 %>" <%= checkDataSelected(time_offout1e39, timeoffout1e39) %>> <%= time_offout1e39 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout1e39" value="<%= timeoffout1e39 %>">  
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_timeoffout2e39 %> : </label>
						...
						<%		String time_offout2e39;
								for(int i = 0; i <= 99; i++){
									if(i < 10) time_offout2e39 = "0" + i; else time_offout2e39 = Integer.toString(i);	
						%>
									<option value="<%= time_offout2e39 %>" <%= checkDataSelected(time_offout2e39, timeoffout2e39) %>> <%= time_offout2e39 %> </option>
						<%		}	%>
								</select>
								<input type="hidden" name="oldtimeoffout2e39" value="<%= timeoffout2e39 %>">
							</div>
						</div> 
						<div class="row form-group" style="margin-left: -25px; margin-right: -10px">
							<label class="control-label label-text-1 col-md-6"> <%= lb_auto_settime %>&nbsp; </label>
					...
					<div class="row form-group" style="margin-bottom: 0px;">
						<div class="col-md-12" align="center"> 
							...
							<input type="button" class="btn btn-primary btn-sm button-shadow1 button-shadow2" id="btnok" value=" &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; " onClick="return ConfirmAddEdit('edit', '<%= msg_confirmedit %>', '<%= msg_notinputdoor %>', '<%= msg_sethostip %>', '<%= msg_notinputlocat %>', '<%= msg_set_doorid %>', '<%= msg_comparemode %>', '<%= msg_doorlock %>', '<%= msg_alarmdoor %>', '<%= msg_doorlock %>');"> &nbsp; 
							<input type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" value=" &nbsp; &nbsp; &nbsp; <%= btn_cancel %> &nbsp; &nbsp; &nbsp; " onClick="location.href='data_door.jsp'">
						</div>
					</div> 
<%	
					...
					<div class="modal-body" align="center">
						<div class="table-responsive" style="border: 0px !important;" border="0"> 
							...
							<div class="col-xs-12 col-md-12" style="margin-bottom: 15px;"> 
								...
								<div class="col-xs-5 col-md-5">
									<button type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" onClick="javascript: location.href = 'data_door.jsp';" style="width: 100%;"> <%= btn_cancel %> </button>
								</div>
								<div class="col-xs-1 col-md-1"> 
