-- MySQL CREATE VIEW
-- TAFF_DATA DATABASE FOR ACCESSCONTROL (Update 02/06/2022) 
USE taff_data;

-- 1 CREATE VIEW view_transaction ON TAFF_DATA (Update 07/10/2016)
-- view_transaction curdate
...
-- 2 CREATE VIEW view_trans_event & view_trans_monitor ON TAFF_DATA (Update 22/05/2017)
-- view_trans_event = dbtrans_event UNION dbtransaction_ev
...
-- view_trans_monitor display door
...
-- 3 CREATE VIEW view_report_ta ON TAFF_DATA (Update 02/10/2017)
-- view_report_ta
...
-- 4 CREATE VIEW view_trans_last_idcard ON TAFF_DATA (Update 17/10/2017)
-- view_trans_last_idcard
...
-- 5 CREATE VIEW view_trans_event & view_trans_monitor ON TAFF_DATA (Update 02/06/2022)
-- view_trans_event = dbtrans_event UNION dbtransaction_ev
DROP VIEW IF EXISTS taff_data.view_trans_event;
CREATE OR REPLACE ALGORITHM=UNDEFINED
SQL SECURITY DEFINER VIEW view_trans_event AS
