...
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('04', 'ผ่านโดยการวางบัตร + นิ้วมือ', 'Success by card + finger', '1000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('05', 'ผ่านโดยการกดรหัส + นิ้วมือ', 'Success by keyboard + finger', '1000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('06', 'ติดบัญชีดำ', 'Error blacklist', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('07', 'ผ่านโดยบาร์โค้ด', 'Success by barcode', '1000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('08', '', '', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('09', 'ใช้บัตร Master Card', 'Master Card', '1000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('10', 'ตรวจพบรหัส', 'Detect ID', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('11', 'รูปแบบของรหัสบัตร ไม่ตรงกับที่กำหนดในระบบ', 'Card pattern mismatch', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('12', 'บัตรหมดอายุ ไม่สามารถใช้งานได้', 'Card expire DATE', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('13', 'บัตรยังไม่ถึงวันเริ่มใช้งาน', 'Card start DATE', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('14', 'ลำดับการออกบัตร ไม่ตรงกับที่กำหนดในระบบ', 'Card issue error', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('15', 'ระบบงานที่กำหนดไว้ในบัตร ไม่ตรงกับใน Reader', 'Card application mismatch', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('16', 'รหัสบริษัทที่กำหนดในบัตร ไม่ตรงกับใน Reader', 'Card customer mismatch', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('17', 'ระบบอ่านข้อมูลบัตรยังไม่สมบูรณ์', 'Card remove before end process', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('18', 'วางบัตร แต่ไม่ได้วางนิ้ว', 'Pass card not press finger', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('19', 'วางบัตร แต่ไม่ได้กดรหัสผ่าน', 'Pass card not press pincode', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('20', 'กดรหัสผ่านไม่ถูกต้อง', 'Pincode error', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('21', 'ไม่ได้กำหนดรหัสนี้ไว้ในตารางข้อมูล', 'ID. table mismatch', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('22', 'ช่วงเวลาที่กำหนดไม่อนุญาติให้ผ่าน', 'Timezone mismatch', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('23', 'ลายนิ้วมือไม่ถูกต้อง', 'Finger-print mismatch', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('24', 'ระบบ Anti-Passback ไม่ถูกต้อง ไม่สามารถผ่านได้', 'Anti-passback error', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('25', 'MU ติดต่อกับ CRU1 ไม่ได้', 'CRU1 disconnect', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('26', 'MU ติดต่อกับ CRU1 ได้ตามปกติ', 'CRU1 connect', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('27', 'MU ติดต่อกับ CRU2 ไม่ได้', 'CRU2 disconnect', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('28', 'MU ติดต่อกับ CRU2 ได้ตามปกติ', 'CRU2 connect', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('29', 'ปุ่มเปิดประตูถูกกด', 'Switch press (Input-1)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('30', 'ปุ่มเปิดประตูถูกปล่อย', 'Switch release (Input-1)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('31', 'ประตูเปิด', 'Door open (Input-2)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('32', 'ประตูปิด', 'Door close (Input-2)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('33', 'ชุดล็อคประตูไฟฟ้าทำงาน', 'Bolt lock (Output-1)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('34', 'ชุดล็อคประตูไฟฟ้าถูกปลด', 'Bolt unlock (Output-1)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('35', 'สัญญาณเตือนที่ประตูดัง', 'Alarm buzzer on (Output-2)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('36', 'สัญญาณเตือนที่ประตูเงียบ', 'Alarm buzzer off (Output-2)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('37', 'ระบบ Fire alarm ตึก ส่งสัญญาณเข้า', 'Fire alarm on (Input-3)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('38', 'ระบบ Fire alarm ตึก หยุดส่งสัญญาณเข้า', 'Fire alarm off (Input-3)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('39', 'On (Input-4)', 'On (Input-4)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('40', 'Off (Input-4)', 'Off (Input-4)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('41', 'ระบบไฟฟ้าทำงานตามปกติ', 'Power on', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('42', 'ระบบไฟฟ้าหยุดทำงาน', 'Power off', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('43', 'ระบบสั่งกระดิ่งดัง', 'Bell on (Output-3)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('44', 'ระบบสั่งกระดิ่งหยุดดัง', 'Bell off (Output-3)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('45', 'On (Output-4)', 'On (Output-4)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('46', 'Off (Output-4)', 'Off (Output-4)', '0000100000');
INSERT INTO taff_data.dbo.dbevent (event_code, th_desc, en_desc, event_act) VALUES ('47', 'เพิ่มรหัสพนักงานที่หัวอ่าน', 'Upload ID Table', '0000100000');
