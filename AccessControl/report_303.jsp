...
<% 
	...
	session.setAttribute("subpage", "transaction_event");
	session.setAttribute("subtitle", "report_303");
	session.setAttribute("action", "report_303.jsp?");
...
<html lang="en">
	...
	<%	}	%>	
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_303_excel.jsp";
				}
