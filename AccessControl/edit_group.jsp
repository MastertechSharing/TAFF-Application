...
<% 
	...
	session.setAttribute("action", "edit_group.jsp?"+"&action="+request.getParameter("action")+"&group_code="+request.getParameter("group_code")+"&");	
			...
			function change_class(field_name){
				if(field_name == 'group_code'){
					if(document.form1.group_code.value != ""){
						document.getElementById("textbox_group_code").className = "form-group has-success has-feedback";
						document.getElementById("icon_group_code").className = "glyphicon glyphicon-ok form-control-feedback";
					}else{
						document.getElementById("textbox_group_code").className = "form-group has-error has-feedback";
						document.getElementById("icon_group_code").className = "glyphicon glyphicon glyphicon-star form-control-feedback";
					}
				}
			}
		</script>
				...
				<div class="row" style="border: 0px !important; margin-bottom: -15px; margin-left: 0px; margin-right: 0px;" border="0">
					<div class="bs-callout bs-callout-info"> 
						...
						<div class="row form-group">
							...
							<div class="col-md-4">
								<div class="form-group has-error has-feedback" id="textbox_group_code" style="margin-bottom: 0px">
									<input type="text" class="form-control" id="group_code" name="group_code" maxlength="6" placeholder="<%= lb_groupcode %>" onKeyPress="IsValidCharacter()" onKeyUp="change_class('group_code');" onBlur="change_class('group_code');">
						...
						<div class="row form-group" style="margin-bottom: 0px;">
							<div class="col-md-12" align="center"> 
								<input type="button" class="btn btn-primary btn-sm button-shadow1 button-shadow2" id="btnok" value=" &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; " onClick="return Confirm_add_edit(document.form1.group_code, '<%= msg_confirmedit %>', '<%= msg_notinput_group %>', 'module/act_group.jsp?action=add', 'add');"> &nbsp; 
								<input type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" value=" &nbsp; &nbsp; &nbsp; <%= btn_cancel %> &nbsp; &nbsp; &nbsp; " onClick="location.href='data_group.jsp'">
							</div>
						</div> 
...
<% 		}else if(action.equals("edit")){
			...
			try{
				ResultSet rs = stmtQry.executeQuery("SELECT * FROM dbgroup WHERE (group_code = '"+group_code+"') ");
				while(rs.next()){
				...
				<div class="row" style="border: 0px !important; margin-bottom: -15px; margin-left: 0px; margin-right: 0px;" border="0">
					<div class="bs-callout bs-callout-info"> 
						...
						<div class="row form-group">
							<label class="control-label label-text-1 col-md-2"> <%= lb_groupcode %> : </label>
							<div class="col-md-4">
								<div class="form-group has-success has-feedback" id="textbox_group_code" style="margin-bottom: 0px">
									<input type="text" class="form-control" id="group_code" name="group_code" value="<%= group_code %>" maxlength="6" placeholder="<%= group_code %>" onKeyPress="IsValidCharacter()" onKeyUp="change_class('group_code');" onBlur="change_class('group_code');">
									<span class="glyphicon glyphicon-ok form-control-feedback" id="icon_group_code" aria-hidden="true"> </span>
									<input type="hidden" name="group_code2" id="group_code2" value="<%= group_code %>">
								</div>
							</div>
							<div class="col-md-6" style="margin-top: 6px;"> </div>
						</div>
						...
						<div class="row form-group" style="margin-bottom: 0px;">
							<div class="col-md-12" align="center"> 
								<input type="button" class="btn btn-primary btn-sm button-shadow1 button-shadow2" id="btnok" value=" &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; " onClick="return Confirm_add_edit(document.form1.group_code, '<%= msg_confirmedit %>', '<%= msg_notinput_group %>', 'module/act_group.jsp?action=edit', 'edit');"> &nbsp; 
								<input type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" value=" &nbsp; &nbsp; &nbsp; <%= btn_cancel %> &nbsp; &nbsp; &nbsp; " onClick="location.href='data_group.jsp'">
							</div>
						</div> 
					...
					<div class="modal-body" align="center">
						<div class="table-responsive" style="border: 0px !important;" border="0"> 
							...
							<div class="col-xs-12 col-md-12" style="margin-bottom: 15px;"> 
								...
								<div class="col-xs-5 col-md-5">
									<button type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" onClick="javascript: location.href = 'data_group.jsp';" style="width: 100%;"> <%= btn_cancel %> </button>
								</div>
