...
<% 
	...
	session.setAttribute("action", "report_207_pdf.jsp?");
	...
	<head>
		...
		<script>
			...
			function changePage(screen){
				document.form1.action = "report_207_pdf.jsp?screen="+screen+"&";
				document.getElementById("form1").submit();
			}
		</script>
								...
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										<div class="row alert-message-info" style="height: 32px; margin-left: -10px; margin-top: -10px; margin-right: -10px;">
											<label class="col-xs-6 col-md-6 control-label" style="margin-top: 5px;"> <i class="glyphicon glyphicon-list-alt"> </i> &nbsp; <a href="report_207.jsp"> <%= lb_report_207 %> </a> </label>
