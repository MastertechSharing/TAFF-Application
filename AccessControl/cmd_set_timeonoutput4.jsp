...
<% 
	...
	session.setAttribute("subtitle", "settimeonoutput4");	
	session.setAttribute("action", "cmd_set_timeonoutput4.jsp?");
				...
				<form id="form1" name="form1" method="post">				
					<div class="table-responsive" style="border: 0px !important;" border="0">
						...
						<%		
							...
							try{
								ResultSet rs = stmtQry.executeQuery(selectDbDoorByHostByGroupUser("39", ses_per, ses_group_user, ses_control_reader));
								while(rs.next()){ 
									...
									if(rs.getString("status_no") == null){
										...
										txt_desc = displayTextAlert(rs.getString("status_no"), txt_time, lang, "39");	
									}  
									if(lang.equals("th")){				
