...
<%	
	...
	session.setAttribute("subtitle", "clearidtable");
	session.setAttribute("action", "cmd_clear_idtable.jsp?");
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#btn_ok').on('click', function(){
					...
					//	Submit Form
					if(cRow != 0){
						data_selected = "1";	//	set check ip by selected.
					}else{
						data_selected = "";
					}
			...
			<div class="container">
				...
				<form id="form1" name="form1" method="post">
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="78">
