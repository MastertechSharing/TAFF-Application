...
<% 
	...
	session.setAttribute("subtitle", "writecard");
	session.setAttribute("action", "cmd_write_card.jsp?");
							...
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								<div class="row">
									...
									<h5 class="modal-title col-xs-2 col-md-2"> 
										<input type="text" class="form-control" id="emp_id" name="emp_id" maxlength="16" style="min-height: 32px !important;" onKeyPress="IsValidCharacters()" onKeyUp="get_datatransaction(this.value)">
								...
								<p>
								<div class="row">
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> <div align="right"> <b> <%= lb_type_card %> : </b> </div> </h5>
									<h5 class="modal-title col-xs-9 col-md-9" style="margin-top: 5px;"> 
										<input name="Appcode" id="Appcode" type="radio" value="1" style="margin-left: 0px;" checked> &nbsp; <%= lb_card1k %> 
										<input name="Appcode" id="Appcode" type="radio" value="2" style="margin-left: 80px;"> &nbsp; <%= lb_card4k %> 
									</h5>
								</div>
								<p>
								<div class="row">
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> <div align="right"> <b> <%= lb_clearTransaction %> : </b> </div> </h5>
									<h5 class="modal-title col-xs-9 col-md-9" style="margin-top: 5px;"> 
										<input name="typewritecard" id="typewritecard" type="radio" id="radio3" value="1" style="margin-left:  0px;"> &nbsp; <%= lb_deltransaction %> 
										<input name="typewritecard" id="typewritecard" type="radio" id="radio4" value="0" style="margin-left: 30px;" checked> &nbsp; <%= lb_notdeltransaction %> 
									</h5>
								</div>
							</div>
						</div>
