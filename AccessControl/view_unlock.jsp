...
%>
		...
		<%	if(typeday != 8){	%>
			<div class="row">
				...
				<h5 class="modal-title <%= col2 %>" > <%= checkImgAtPos(group1, 0) %> <%= lb_mgroup1 %> </h5>
			</div>
			<%= set_hr %>
			<div class="row">
				<h5 class="modal-title <%= col1 %>" > <div align="right"> </h5>
				<h5 class="modal-title <%= col2 %>" > <%= checkImgAtPos(group2, 0) %> <%= lb_mgroup2 %> </h5>				
			</div>
		<%	}	%>
		</div>
<%				
