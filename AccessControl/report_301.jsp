...
<% 
	...
	session.setAttribute("subtitle", "report_301");
	session.setAttribute("action", "report_301.jsp?");
								...
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										...
										<div class="row">
											...
											<div class="modal-title col-xs-1 col-md-1">
										<%	if(checkPermissionNot(ses_per, 9)){	%>
												<img  src="images/view.png" width="28" height="28" border="0" align="absmiddle" onClick="show_detail2();" data-toggle="tooltip" data-placement="right" data-container="body" title="<%= lb_viewdata %>"/>
										<%	}	%>
											</div>
										...
										<div class="row">
											...
											<div class="modal-title col-xs-3 col-md-3"> 
												<select class="form-control" name="select_orderby" id="select_orderby" style="max-height: 28px !important; font-size: 12px !important;">
													...
													<option value="1"> <%= lb_events %> </option>
													<option value="2"> <%= lb_date %> </option>
													<option value="3"> <%= lb_doorcode %> </option>
													<option value="4"> <%= lb_code %> </option>
												</select>
											</div>
	...
	<%	}	%>	
		...
		<script>
			...
			function show_detail2(){
				view_detail.location = 'iframe_data.jsp?ac=event&ac_code=1';
				$('#myModalViewDetail').modal('show');
			}
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_301_excel.jsp";
				}
