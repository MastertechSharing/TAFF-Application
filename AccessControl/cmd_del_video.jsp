...
<%	
	...
	session.setAttribute("subtitle", "delvideo");
	session.setAttribute("action", "cmd_del_video.jsp?");
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#btn_ok').on('click', function(){
					...
					onSubmitGetSet(data_selected, document.form1.files, '<%= lb_del_file %>', '<%= lb_delallcmdD2 %>', '<%= lang %>', 'vdo', '<%= lb_no_datadoor %>', '<%= msg_ps_selectdoor %>');
					return false;
				});
			});
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
			...
			<div class="container">
				...
				<form id="form1" name="form1" method="post">
					...
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								<div class="row">
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 6px;"> <div align="right"> <b>  <%= lb_selfilevio %> : </b> </div> </h5>
								...
								<div class="row">
									...
									<h5 class="modal-title col-xs-9 col-md-9"> 
										<input type="checkbox" name="delall" id="delall" onclick="checkedid('<%= lb_msgvideo_del %>')" /> <%= lb_delallcmdD2 %>
									</h5>
								</div>
							</div>
						</div>
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="D2">
		...
		<script>
			function show_detail(){
				view_detail.location = 'iframe_listfile.jsp?listfile=vdo';
