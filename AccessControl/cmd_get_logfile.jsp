...
<% 
	...
	session.setAttribute("subtitle", "getlogfile");
	session.setAttribute("action", "cmd_get_logfile.jsp?");
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<div class="body-display">
			<div class="container">
				...
				<%	if(sw_version.equals("67")){	%>
					<input type="hidden" name="rdo_reader" value="5" >	
				<%	}else{	%>
				...
				<%	}	%>
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="58">
