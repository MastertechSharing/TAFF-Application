	...
	if (session.getAttribute("ses_permission") == null) {
		...
		try{
			...
			while (rs.next()) {
				...
				JSONArray ja = new JSONArray();
				if(checkPermission(ses_per, "0")){
					ja.put("<center> <img src='images/group.png' width='22' height='20' border='0' onClick='show_detail(\""+reader_no+"\", \"employee\");' data-toggle='tooltip' data-placement='right' data-html='true' title='"+lb_view_list_employee+"'> </center>");
