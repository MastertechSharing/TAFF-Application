...
<%	
	...
	if (session.getAttribute("ses_permission") == null) {
		...
		if(checkPermission(ses_per, "0")){
			cols = new String[]{ "", "", "", "", "reader_no", "th_desc", "en_desc", "door_id", "locate_code" };
		}else{
			cols = new String[]{ "reader_no", "th_desc", "en_desc", "door_id", "locate_code", "", "", "", "" };
		}
		...
		try{
			...
			if(mode == 0){		
				sql = "SELECT rd.reader_no, rd.th_desc AS rd_th_desc, rd.en_desc AS rd_en_desc, "
					...
					+ "FROM dbreader rd "
					+ "LEFT JOIN dbdoor door ON (rd.door_id = door.door_id) "
			...
			while (rs.next()) {
				...
				String reader_no_link = "<b> <a href='#' onClick='show_detail(\""+reader_no+"\", \"\");' data-toggle='tooltip' data-placement='left' data-html='true' title='"+lb_viewdata+"'>" + reader_no + "</a> </b>";
				...
				door_id_link = "<b> <a href='#' onClick='show_detail2(\""+door_id+"\");' data-toggle='tooltip' data-placement='left' data-html='true' title='"+lb_viewdata+"'>" + door_id + "</a> </b>";
				...
				locate_code_link = "<b> <a href='#' onClick='show_detail3(\""+locate_code+"\");' data-toggle='tooltip' data-placement='left' data-html='true' title='"+lb_viewdata+"'>" + locate_code + "</a> </b>";
				...
				JSONArray ja = new JSONArray();
				if(checkPermission(ses_per, "0")){
					ja.put("<center> <img src='images/group.png' width='22' height='20' border='0' onClick='show_detail(\""+reader_no+"\", \"transaction\");' data-toggle='tooltip' data-placement='right' data-html='true' title='"+lb_view_list_employee+"'> </center>");
					ja.put("<center> <img src='images/ids.png' width='22' height='20' border='0' onClick='downloadFile(\""+reader_no+"\", \"IDS\");' data-toggle='tooltip' data-placement='right' data-html='true' title='"+lb_download_file+" .IDS'> </center>");
					ja.put("<center> <img src='images/xml.png' width='22' height='20' border='0' onClick='downloadFile(\""+reader_no+"\", \"XML\");' data-toggle='tooltip' data-placement='right' data-html='true' title='"+lb_download_file+" .XML'> </center>");
					ja.put("<center> <img src='images/csv.png' width='22' height='20' border='0' onClick='downloadFile(\""+reader_no+"\", \"CSV\");' data-toggle='tooltip' data-placement='right' data-html='true' title='"+lb_download_file+" .CSV'> </center>");
				}
				ja.put("<center> "+ reader_no_link +" </center>");
				ja.put("<div class='ellipsis_string' style='max-width: 220px;'> <span class='pad-left-10'> "+ th_name +" </span> </div>");
				ja.put("<div class='ellipsis_string' style='max-width: 220px;'> <span class='pad-left-10'> "+ en_name +" </span> </div>");
				ja.put("<div class='ellipsis_string' style='max-width: 220px;'> <span class='pad-left-10'> "+ door_id_link +" </span> </div>");
				ja.put("<div class='ellipsis_string' style='max-width: 220px;'> <span class='pad-left-10'> "+ locate_code_link +" </span> </div>");
				array.put(ja);
			}
			rs.close();
