...
<% 
	...
	session.setAttribute("subtitle", "report_blacklist");
	session.setAttribute("action", "report_blacklist.jsp?");
...
<html lang="en">
		...
		<script>
			...
			$(document).ready(function() {
				...
				<%	}	%>
					...
					fncSubmit('<%= lang %>', '<%= lb_no_datasection %>', '<%= msg_ps_selectsection %>', cRow_section);
					return false;
				});
									...
									<div class="bs-callout bs-callout-info"> 
										...
										<div class="row">
											<h5 class="modal-title col-xs-2 col-md-2" style="margin-top: 4px;"> 
												<div align="right"> <input name="chk_date_blacklist" type="checkbox"> &nbsp; <b> <%= lb_blacklist_date %> : </b> </div> 
											</h5>
											<div class="modal-title col-xs-3 col-md-3">
												<div class="input-group col-md-12">
													<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="st_date_blacklist" data-link-format="dd/mm/yyyy">
													...
													<input type="hidden" class="form-control" id="st_date_blacklist" name="st_date_blacklist" maxlength="10" value="<%= getCurrentDate() %>" placeholder="<%= lb_date %>" readonly="readonly" style="background-color:#F0F0F0">
												</div>
											</div>											
											<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 4px;"> <div align="right"> <b> <%= lb_to_date %> : </b> </div> </h5>
											<div class="modal-title col-xs-3 col-md-3">
												<div class="input-group col-md-12">
													<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="ed_date_blacklist" data-link-format="dd/mm/yyyy">
														<input type="text" class="form-control" style="min-height: 28px !important; background-color:#F0F0F0" value="<%= getCurrentDate() %>" readonly>
														<span class="input-group-addon"><span class="glyphicon glyphicon-calendar" style="font-size: 12px !important;"></span></span>
													</div>
													<input type="hidden" class="form-control" id="ed_date_blacklist" name="ed_date_blacklist" maxlength="10" value="<%= getCurrentDate() %>" placeholder="<%= lb_to_date %>" readonly="readonly" style="background-color:#F0F0F0">
												</div>
											</div> 
											<div class="modal-title col-xs-1 col-md-1"> </div> 
										</div>										
										...
										<div class="row">
											<h5 class="modal-title col-xs-2 col-md-2" style="margin-top: 4px;">
												<div align="right"> <input name="chk_date_cancel" type="checkbox"> &nbsp; <b> <%= lb_cancel_date %> : </b> </div>
											</h5>
											<div class="modal-title col-xs-3 col-md-3">
												<div class="input-group col-md-12">
													<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="st_date_cancel" data-link-format="dd/mm/yyyy">
														<input type="text" class="form-control" style="min-height: 28px !important; background-color:#F0F0F0" value="<%= getCurrentDate() %>" readonly>
														<span class="input-group-addon"><span class="glyphicon glyphicon-calendar" style="font-size: 12px !important;"></span></span>
													</div>
													<input type="hidden" class="form-control" id="st_date_cancel" name="st_date_cancel" maxlength="10" value="<%= getCurrentDate() %>" placeholder="<%= lb_date %>" readonly="readonly" style="background-color:#F0F0F0">
												</div>
											</div>
											<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 4px;"> <div align="right"> <b> <%= lb_to_date %> : </b> </div> </h5>
											<div class="modal-title col-xs-3 col-md-3">
												<div class="input-group col-md-12">
													<div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="ed_date_cancel" data-link-format="dd/mm/yyyy">
														<input type="text" class="form-control" style="min-height: 28px !important; background-color:#F0F0F0" value="<%= getCurrentDate() %>" readonly>
														<span class="input-group-addon"><span class="glyphicon glyphicon-calendar" style="font-size: 12px !important;"></span></span>
													</div>
													<input type="hidden" class="form-control" id="ed_date_cancel" name="ed_date_cancel" maxlength="10" value="<%= getCurrentDate() %>" placeholder="<%= lb_to_date %>" readonly="readonly" style="background-color:#F0F0F0">
												</div>
											</div> 
											<div class="modal-title col-xs-1 col-md-1"> </div> 											
										</div>										
										<p>
										<div class="row">
											<h5 class="modal-title col-xs-2 col-md-2" style="margin-top: 4px;"> <div align="right"> <b> <%= lb_blacklist2 %> : </b> </div> </h5>
											<div class="modal-title col-xs-2 col-md-2"> <input name="chk_blacklist" id="chk_blacklist" type="radio" value="2" checked> &nbsp; <%= lb_all %> </div> 
											<div class="modal-title col-xs-2 col-md-2"> <input name="chk_blacklist" id="chk_blacklist" type="radio" value="0"> &nbsp; <%= lb_blacklist2 %> </div> 
											<div class="modal-title col-xs-2 col-md-2"> <input name="chk_blacklist" id="chk_blacklist" type="radio" value="1"> &nbsp; <%= btn_cancel %> <%= lb_blacklist2 %> </div> 
										</div>
										<p>
										<div class="row">
						...
						<div <%= width_align %> class="table" border="0">
							...
							<div class="row" style="margin-left: 0px; margin-right: 0px;">
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										<div class="row alert-message-info" style="height: 32px; margin-left: -10px; margin-top: -10px; margin-right: -10px;">
											<label class="control-label" style="margin-left: 2%; margin-top: 5px;"> 
												<b> <%= lb_section %> </b>
											</label>
										</div>
	...
	<%	}	%>	
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, cRow_section){	
				...
				if(document.form1.chk_date_blacklist.checked == true){
					std_bl = form1.st_date_blacklist.value;
					exd_bl = form1.ed_date_blacklist.value;	
					sub_std_bl = std_bl.substring(6,10)+std_bl.substring(3,5)+std_bl.substring(0,2);
					sub_edd_bl = exd_bl.substring(6,10)+exd_bl.substring(3,5)+exd_bl.substring(0,2);
					chkd_bl = "1";
					if(sub_std_bl > sub_edd_bl){
						if(lang == "th"){
							text_warning = 'กำหนดวันที่บันทึกบัญชีดำ ไม่ถูกต้อง<br/><br/>[ วันที่เริ่มต้นต้องไม่มากกว่าวันที่สิ้นสุด ]';
						}else{
				...
				if(document.form1.chk_date_cancel.checked == true){
					std_cc = form1.st_date_cancel.value;
					edd_cc = form1.ed_date_cancel.value;
					sub_std_cc = std_cc.substring(6,10)+std_cc.substring(3,5)+std_cc.substring(0,2);
					sub_edd_cc = edd_cc.substring(6,10)+edd_cc.substring(3,5)+edd_cc.substring(0,2);
					chkd_cc = "1";
					if(sub_std_cc > sub_edd_cc){			
						if(lang == "th"){
							text_warning = 'กำหนดวันที่ยกเลิกบัญชีดำ ไม่ถูกต้อง<br/><br/>[ วันที่เริ่มต้นต้องไม่มากกว่าวันที่สิ้นสุด ]';
						}else{
			...
			<%	}	%>
				...
				if(document.form1.pagefile.value == "pdf"){
					document.form1.action = "report_blacklist_pdf.jsp?emp_id="+emp_id+"&chk_date_blacklist="+chkd_bl+"&st_date_blacklist="+std_bl+"&ed_date_blacklist="+exd_bl+"&chk_date_cancel="+chkd_cc+"&st_date_cancel="+std_cc+"&ed_date_cancel="+edd_cc+"&select_sec=all&lang="+lang+"&";
				}else if(document.form1.pagefile.value == "xls"){
					document.form1.action = "report_blacklist_excel.jsp?emp_id="+emp_id+"&chk_date_blacklist="+chkd_bl+"&st_date_blacklist="+std_bl+"&ed_date_blacklist="+exd_bl+"&chk_date_cancel="+chkd_cc+"&st_date_cancel="+std_cc+"&ed_date_cancel="+edd_cc+"&select_sec=all&lang="+lang+"&";
				}
