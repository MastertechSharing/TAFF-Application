...
<% 
	...
	session.setAttribute("subtitle", "setunlock");
	session.setAttribute("action", "cmd_set_unlock.jsp?");
				...
				<form id="form1" name="form1" method="post" action="SetRequest.do">				
					<div class="table-responsive" style="border: 0px !important;" border="0">
						...
						<%	
							...
							try{
								ResultSet rs = stmtQry.executeQuery(selectDbDoorByHostByGroupUser("33", ses_per, ses_group_user, ses_control_reader));
								while(rs.next()){ 
									...
									if(rs.getString("status_no") == null){
										...
										txt_desc = displayTextAlert(rs.getString("status_no"), txt_time, lang, "33");	
									}  
									if(lang.equals("th")){				
