...
<% 
	...
	session.setAttribute("subtitle", "report_111");	
	session.setAttribute("action", "report_111.jsp?");
								...
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										...
										<div class="row">
											...
											<div class="modal-title col-xs-7 col-md-7"> </div> 
										</div>
										<p>
										<div class="row">
											...
											<div class="modal-title col-xs-3 col-md-3"> 
												...
												<!--	<option selected> <%= lb_selectfield %> </option>	-->
													...
													<option value="2"> <%= lb_timein %> </option>
													<option value="3"> <%= lb_timeout %> </option>
													<option value="4" selected> <%= lb_timesafety %> </option>
												</select>
											</div>
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_111_excel.jsp";
				}
