...
<% 
	...
	session.setAttribute("subtitle", "report_110");	
	session.setAttribute("action", "report_110.jsp?");
							...
							<div class="row" style="margin-left: 0px; margin-right: 0px;">
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										...
										<p>
										<div class="row">
											<h5 class="modal-title col-xs-2 col-md-2" style="margin-top: 4px;"> <div align="right"> <b> <%= lb_duty %> : </b> </div> </h5>
											<div class="modal-title col-xs-3 col-md-3"> 
												<select class="form-control" name="duty" id="duty" style="max-height: 28px !important; font-size: 12px !important;">
													<option value="" selected> <%= lb_all %> </option>
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_110_excel.jsp";
				}
