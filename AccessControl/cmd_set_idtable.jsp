...
<% 
	...
	session.setAttribute("subtitle", "setidtable");
	session.setAttribute("action", "cmd_set_idtable.jsp?");
...
<html lang="en">
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
					...
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							...
							<%	}else{	%>
								<p>
								<div class="row">
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> <div align="right"> <b> <%= lb_readertype %> : </b> </div> </h5>
		...
		//	}
			...
			function chkKeyBlacklist(){
				$('#form1').attr('action', 'cmd_set_idtable_iframe.jsp?action=onKey&idcard='+$('#emp_id').val());
				$('#form1').attr('target', 'iframe_chkblacklist');
				$('#form1').submit();
			}
			
			function chkChangeBlacklist(){
				$('#form1').attr('action', 'cmd_set_idtable_iframe.jsp?action=onChange&idcard='+$('#emp_id').val());
				$('#form1').attr('target', 'iframe_chkblacklist');
				$('#form1').submit();
			}
