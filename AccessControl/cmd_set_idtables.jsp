...
<%	
	...
	session.setAttribute("subtitle", "setidtables");
	session.setAttribute("action", "cmd_set_idtables.jsp?");
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onload="onLoads('<%= lang %>');">
				...
				<form id="form1" name="form1" method="post">					
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							<div class="bs-callout bs-callout-info" style="margin-left: 3px; margin-right: 5px;">
								<div class="row">
								...
								<div class="row">	
									...
									<h5 class="modal-title col-xs-9 col-md-9">
									<!--	<label class="control-label"> <div align="left"> MU : </div> </label>
										<select class="form-control selectpicker" data-width="10%" data-container="body" data-size="10" name="rdo_mu" id="rdo_mu">
											<option value="0"> <%= lb_noupdate %> </option>
											<option value="1" selected> <%=lb_update %> </option>
											<option value="2"> <%= lb_del %> </option>
										</select>
										
										<label class="control-label" style="margin-left: 100px;"> <div align="left"> CRU1 : </div> </label>	-->
									...
									<!--	<label class="control-label" style="margin-left: 100px;"> <div align="left"> CRU2 : </div> </label>
										<select class="form-control selectpicker" data-width="10%" data-container="body" data-size="10" name="rdo_cru2" id="rdo_cru2">
											<option value="0"> <%= lb_noupdate %> </option>
											<option value="1" selected> <%= lb_update %> </option>
											<option value="2"> <%= lb_del %> </option>
										</select>	-->
		...
		<script>
			function show_detail(){
				view_detail.location = 'iframe_employees.jsp';
