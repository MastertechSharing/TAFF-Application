...
<% 
	...
	session.setAttribute("subtitle", "facesetdatetime");
	session.setAttribute("action", "cmd_face_set_datetime.jsp?");
			...
			<div class="container">
				<form id="form1" name="form1" method="post">	
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="F1">
						<input type="hidden" name="mode" value="A">						
						<button class="btn btn-primary btn-sm max-height-26 button-shadow1 button-shadow2" name="btn_okA" id="btn_okA" onMouseOver="this.style.cursor='hand';"> &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; </button> &nbsp;
