...
<%	
	...
	session.setAttribute("subtitle", "getversion");
	session.setAttribute("action", "cmd_get_version_report.jsp?");
...
<html lang="en">
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="min-width: 1000px; margin-top: -50px;" onLoad="sendRequest(); ShowCurrentTime(); updateClock();">
		...
		<div class="table-responsive" style="border: 0px !important; margin-bottom: -55px;" border="0">
			...
			<table style="min-width: 1000px; margin-bottom: 0px;" class="table table-hover" align="center" id="table1" border="0">
				<thead>
					...
					<td width="13%" align="center"> <b> MU </b> </td>
					<td width="13%" align="center"> <b> Reader 1 </b> </td>
					<td width="13%" align="center"> <b> Reader 2 </b> </td>
				</thead>
			</table>
		</div>
