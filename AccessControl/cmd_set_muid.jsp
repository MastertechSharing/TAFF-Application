...
<% 
	...
	session.setAttribute("subtitle", "setmuid");
	session.setAttribute("action", "cmd_set_muid.jsp?");
		...
		<script>
			...
			$(document).ready(function() {
				...
				$('#btn_ok').on('click', function(){
					...
					$.each(table.column(0).data(), function(index, rowId){
						$('input[name="hid_'+rowId+'"]', form).remove();
					});
					...
					$.each(rows_selected, function(index, rowId){
						...
						$(form).append($('<input>').attr('type', 'hidden').attr('name', 'hid_'+rowId).val(rowId));
			...
			<div class="container">			
				...
				<form id="form1" name="form1" method="post">				
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="72">
