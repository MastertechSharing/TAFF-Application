...
<% 
	...
	session.setAttribute("subtitle", "downloadtxt_con");
	session.setAttribute("action", "file_download_txt_conditions.jsp?");
											...
											<div class="modal-title col-xs-6 col-md-6" align="right">
												<div class="btn-group" id="btn_action">
													<div class="btn-group dropup">
														<button class="btn btn-primary btn-sm max-height-26 button-shadow1 button-shadow2" name="btn_pdf" id="btn_pdf" onClick="javascript: $('#pagefile').val('txt');" onMouseOver="this.style.cursor='hand';"> &nbsp; &nbsp; &nbsp; <strong> <%= lb_download_data %> </strong> &nbsp; &nbsp; </button>
													</div>
												</div>
	...
	<%	}	%>	
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
					...
					if(document.form1.emp_id.value == ""){
						...
						if(cRow_section != ''){
							if(lang == "th"){
								...
								ModalWarning_TextName("You selected section. Can not select idcardx", "");
							}
				...
				if(document.form1.pagefile.value == "txt"){		
					document.form1.action = "file_download_txt_conditions_download.jsp";
				}
