...
<%	
	...
	session.setAttribute("subtitle", "report_102");	
	session.setAttribute("action", "report_102.jsp?");
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_102_excel.jsp";
				}
