...
<% 
	...
	session.setAttribute("subtitle", "getnumtemplate");
	session.setAttribute("action", "cmd_get_numtemplate.jsp?");
						...
						<div style="min-width: 550px;" class="table" border="0">
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								<div class="row">
									...
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> 
										<div style="min-height: 29px;"> <input name="rdo_reader" id="reader1" type="radio" value="1" checked> &nbsp; Reader 1 </div>
									</h5>
									<h5 class="modal-title col-xs-6 col-md-6" style="margin-top: 5px;"> 
										<div style="min-height: 29px;"> <input name="rdo_reader" id="reader2" type="radio" value="2"> &nbsp; Reader 2 </div>
									</h5>
								</div>
							</div>
						</div>
