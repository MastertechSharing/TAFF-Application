...
<%	
	...
	session.setAttribute("subtitle", "setactionevent");
	session.setAttribute("action", "cmd_set_actionevent.jsp?");
			...
			<div class="container">			
				<form id="form1" name="form1" method="post">				
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								<div class="row">
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> <div align="right"> <b> <%=lb_action%> : </b> </div> </h5>
									<div class="modal-title col-xs-2 col-md-2" > 
										<select class="form-control selectpicker" data-live-search="true" data-width="60%" data-size="12" data-container="body" name="action" id="action">
										<option value="1" selected> &nbsp; Lock</option>
										<option value="2" > &nbsp; Unlock</option>
										<option value="3" > &nbsp; Alarm</option>
										<option value="4" > &nbsp; Output 3</option>
										<option value="5" > &nbsp; Output 4</option>
										</select>
									</div>								
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> <div align="right"> <b> <%= lb_actionduration %> : </b> </div> </h5>
									<div class="modal-title col-xs-4 col-md-4" > 
										<select class="form-control selectpicker" data-live-search="true" data-width="40%" data-size="12" data-container="body" name="timeduration" id="timeduration">
										<%	String loop3;
											for(int i = 0; i <= 99; i++){
												if(i < 10) loop3 = "0" + i; else loop3 = Integer.toString(i);
										%>	<option value="<%= loop3 %>" <%= checkDataSelected(loop3, "60") %>> <%= loop3 %> </option>
										<%	}	%>
										</select> 												
									</div>													
								</div>
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="91">
