...
<% 
	...
	session.setAttribute("subtitle", "report_206");
	session.setAttribute("action", "report_206.jsp?");
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, cRow_door){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_206_excel.jsp";
				}
