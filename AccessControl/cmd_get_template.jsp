...
<% 
	...
	session.setAttribute("action", "cmd_get_template.jsp?");
								...
								<div class="row">
									...
									<h5 class="modal-title col-xs-9 col-md-9" style="margin-top: 5px;"> 
										<div style="min-height: 24px;">
											<input name="rdo_reader" id="reader1" type="radio" value="1" style="margin-left:  0px;" checked> &nbsp; Reader 1
											<input name="rdo_reader" id="reader2" type="radio" value="2" style="margin-left: 120px;"> &nbsp; Reader 2
										</div>
									</h5>
								</div>
							</div>
					...
					<div class="col-xs-4" align="center"> 
						...
						<% 
							if(getModuleF(stmtQry).equals("0")){
								out.println("<input type='hidden' name='command' value='21'>");
							}else{
								out.println("<input type='hidden' name='command' value='40'>");
							}
						%>
