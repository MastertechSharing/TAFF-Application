...
<%	
	...
	session.setAttribute("action", "cmd_dump_transbydatetime.jsp?");	
			...
			<div class="container">
				...
				<form id="form1" name="form1" method="post">
					...
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								<div class="row">
									<h5 class="modal-title col-xs-2 col-md-2" style="margin-top: 6px;"> <div align="right"> <b> <%= lb_date %> : </b> </div> </h5>
									...
									<h5 class="modal-title col-xs-1 col-md-1" style="margin-top: 6px;"> <div align="right"> <b> <%= lb_todate %> : </b> </div> </h5>
									<div class="modal-title col-xs-2 col-md-2"> 
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="69">
