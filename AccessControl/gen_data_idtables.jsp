...
<% 	
	...
	session.setAttribute("subtitle", "download_from_emp");
...
<html lang="en">
			...
			function Load_DataTable(){
				$(document).ready(function() {
					$('#data_table').dataTable( {
						...
						"bServerSide": true,
						"bProcessing": true,
						"sAjaxSource": "gen_data_idtables_server_side.jsp",
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="Clear_Session_Table('<%= clear_session %>', 'DataTables_data_table_<%= request.getRequestURI() %>'); Load_DataTable();">
		...
		function downloadFile(reader_no, type_file){
			...
			frames['iframe_gendata'].location.href = 'gen_data_idtables_file.jsp?reader_no='+reader_no+'&type_file='+type_file+'&type_data=employee';
		}
