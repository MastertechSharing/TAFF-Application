...
<%	
	...
	session.setAttribute("subtitle", "getnumidtable");
	session.setAttribute("action", "cmd_get_numidtable_report.jsp?");
...
<html lang="en">
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="min-width: 800px; margin-top: -50px;" onLoad="sendRequest(); ShowCurrentTime(); updateClock();">
		...
		<div class="table-responsive" style="border: 0px !important; margin-bottom: -55px;" border="0">
			...
			<table style="min-width: 800px; margin-bottom: 0px;" class="table table-hover" align="center" id="table1" border="0">
				<thead>
					...
					<td width="21%" align="center"> <b> <%= lb_description %> </b> </td>
					<td width="10%" align="center"> <b> <%= lb_result %> </b> </td>
					<td width="14%" align="center"> <b> Free/Full Table1 </b> </td>
					<td width="8%" align="center"> <b> Used ID1 </b> </td>
					<td width="14%" align="center"> <b> Free/Full Table2 </b> </td>
					<td width="8%" align="center"> <b> Used ID2 </b> </td>
				</thead>
			</table>
		</div>
