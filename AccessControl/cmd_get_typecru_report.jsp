...
<%	
	...
	session.setAttribute("subtitle", "gettypecru");
	session.setAttribute("action", "cmd_get_typecru_report.jsp?");
		...
		<div class="table-responsive" style="border: 0px !important; margin-bottom: -55px;" border="0">
			...
			<table style="min-width: 550px; margin-bottom: 0px;" class="table table-hover" align="center" id="table1" border="0">
				<thead>
					...
					<td width="15%" align="center"> <b> Reader 1 </b> </td>
					<td width="15%" align="center"> <b> Reader 2 </b> </td>
				</thead>
			</table>
		</div>
