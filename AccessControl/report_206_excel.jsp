...
<% 
	...
	session.setAttribute("action", "report_202_excel.jsp?");  
%>
...
<%	
	...
	if(date_time1.compareTo(date_time2) > 0){
		...
		String fileName = report_id+"_All_Transaction_By_Door.xls";		
		int num = 0;	
		int num_id = 0;		
		try{
			...
			row_date.createCell((short)7).setCellValue(lb_date+"   "+getCurrentDate()+"   "+lb_time+"  "+getCurrentTimeShort());	
