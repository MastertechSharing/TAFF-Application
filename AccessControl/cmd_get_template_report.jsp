...
<%	
	...
	session.setAttribute("subtitle", "gettemplate"); 
	session.setAttribute("action", "cmd_get_template_report.jsp?");
...
<html lang="en">
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="min-width: 1300px; margin-top: -50px;" onLoad="sendRequest(); ShowCurrentTime(); updateClock();">
		...
		<div class="table-responsive" style="border: 0px !important; margin-bottom: -55px;" border="0">
			...
			<div style="overflow-y: auto; overflow-x: hidden; width: 1300px" border="0">
				<table style="min-width: 1300px; margin-bottom: 0px;" class="table table-hover" align="center" id="table1" border="0">
					<thead>
						...
						<td width="8%" align="center" > <b> <%= lb_temp %> 1 </b> </td>
						<td width="8%" align="center" > <b> <%= lb_temp %> 2 </b> </td>
						<td width="14%" align="center" > <b> <%= lb_dateupdate %> </b> </td>
					</thead>
				</table>
			</div>
		</div>
