...
<html lang="en">
	<head>
		...
		<script>
			function onLoad(){
				document.form1.action = "ReportBlacklist.do";
	...
	<%	}	%>	
		...
		<div class="body-display">
			<div class="container">
				...
				<form name="form1" id="form1" action="ReportBlacklist.do" target="show_body" method="post">
			...
			%>		
					...
					<input type="hidden" name="chk_blacklist" value="<%= chk_blacklist %>">
					<input type="hidden" name="chk_date_blacklist" value="<%= chk_date_blacklist %>">
					<input type="hidden" name="chk_date_cancel" value="<%= chk_date_cancel %>">
					
					<input type="hidden" name="st_date_blacklist" value="<%= st_date_blacklist %>">
					<input type="hidden" name="ed_date_blacklist" value="<%= ed_date_blacklist %>">
					<input type="hidden" name="st_date_cancel" value="<%= st_date_cancel %>">
					<input type="hidden" name="ed_date_cancel" value="<%= ed_date_cancel %>">
								...
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										<div class="row alert-message-info" style="height: 32px; margin-left: -10px; margin-top: -10px; margin-right: -10px;">
											<label class="col-xs-6 col-md-6 control-label" style="margin-top: 5px;"> <i class="glyphicon glyphicon-list-alt"> </i> &nbsp; <a href="report_blacklist.jsp"> <%= lb_blacklist %> </a> </label>
										</div>
