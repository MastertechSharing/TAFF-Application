...
<%	
	...
	session.setAttribute("subtitle", "getlistvideo");
	session.setAttribute("action", "cmd_get_listvideo_report.jsp?");
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="margin-top: -50px;" onLoad="sendRequest(); ShowCurrentTime(); updateClock();">
					...
					<div class="modal-body" align="center">
						<div class="table-responsive" style="border: 0px !important;" border="0"> 
							<div class="col-xs-12 col-md-12" style="margin-top: -10px;"> 
								<iframe id="show_listvideo" name="show_listvideo" src="" width="545px" height="335px" frameborder="0" scrolling="yes"></iframe>
							</div>
		...
		<script>
			...
			function showList(ip, door_id){
				tmpip = ip;
				tmpdoor_id = door_id;
				show_listvideo.location.href = 'cmd_get_listvideo_report_data.jsp?ip='+ip+'&door_id='+door_id;
