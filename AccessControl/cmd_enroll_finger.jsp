...
<%	
	...
	session.setAttribute("action", "cmd_enroll_finger.jsp?");	
					...
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								...
								<p>
								<div class="row">
									<h5 class="modal-title col-xs-3 col-md-3" style="margin-top: 5px;"> <div align="right"> <b> <%= lb_fingers %> : </b> </div> </h5>
								...
								<div class="row">
									...
									<div class="modal-title col-xs-10 col-md-10">
										<p>
										<table width="100%" class="table table-bordered" style="margin-top: -10px; margin-bottom: 0px;" cellspacing="0">
											<tr class="active">
