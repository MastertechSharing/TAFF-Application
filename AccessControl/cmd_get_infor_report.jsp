...
<%	
	...
	session.setAttribute("subtitle", "getinfor");
	session.setAttribute("action", "cmd_get_infor_report.jsp?");
			...
			<div style="overflow-y: auto; overflow-x: hidden; width: 1600px" border="0">
				<table style="min-width: 1000px; margin-bottom: 0px;" class="table table-hover" align="center" id="table1" border="0">
					<thead>
						...
						<td width="8%" align="center"> <b> <%= lb_datetime %> </b> </td>
						<td width="5%" align="center"> <b> MU ID </b> </td>
						<td width="8%" align="center"> <b> MU </b> </td>
						<td width="8%" align="center"> <b> Reader 1 </b> </td>
						<td width="8%" align="center"> <b> Reader 2 </b> </td>
						<td width="8%" align="center"> <b> Free/Full Rec. </b> </td>
						<td width="5%" align="center"> <b> Used Rec. </b> </td>
					</thead>
				</table>
			</div>
		</div>
