...
<% 
	...
	session.setAttribute("subtitle", "setconfig");
	session.setAttribute("action", "cmd_set_config.jsp?");
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<div class="body-display">
			<div class="container">			
				...
				<%	if(sw_version.equals("67")){	%>
					<input type="hidden" name="rdo_reader" value="4" >	
				<%	}else{	%>
								...
								<div class="row">
									...
									<h5 class="modal-title col-xs-9 col-md-9" style="margin-top: 5px;"> 
										<div style="min-height: 29px;">
											<input name="rdo_reader" type="radio" value="1" style="margin-left:  0px;"> &nbsp; Reader 1
											<input name="rdo_reader" type="radio" value="2" style="margin-left: 30px;"> &nbsp; Reader 2
											<input name="rdo_reader" type="radio" value="3" style="margin-left: 30px;"> &nbsp; Main Unit 
											<input name="rdo_reader" type="radio" value="4" style="margin-left: 30px;" checked> &nbsp; <%= lb_allfunction %>
										</div>
									</h5>
								</div>
							</div>
				...
				<%	}	%>
					...
					<div class="table-responsive" style="border: 0px !important; <% if(!sw_version.equals("67")){ out.println("margin-top: -10px;"); } %>" border="0">
						...
						<%	
							...
							try{
								ResultSet rs = stmtQry.executeQuery(selectDbDoorByHostByGroupUser("30", ses_per, ses_group_user, ses_control_reader));
								while(rs.next()){ 
									...
									if(rs.getString("status_no") == null){
										...
										txt_desc = displayTextAlert(rs.getString("status_no"), txt_time, lang, "30");	
									}  
									if(lang.equals("th")){				
