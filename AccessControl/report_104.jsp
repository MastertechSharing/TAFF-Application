...
<% 
	...
	session.setAttribute("subtitle", "report_104");	
	session.setAttribute("action", "report_104.jsp?");
		...
		<script>
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					document.form1.action = "report_104_pdf.jsp";
				}else if(document.form1.pagefile.value == "xls"){
					document.form1.action = "report_104_excel.jsp";
				}
