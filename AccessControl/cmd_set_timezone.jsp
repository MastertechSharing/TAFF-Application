...
<% 
	...
	session.setAttribute("subtitle", "settimezone"); 
	session.setAttribute("action", "cmd_set_timezone.jsp?");
...
<html lang="en">
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<div class="body-display">
			<div class="container">			
				<form id="form1" name="form1" method="post" action="SetRequest.do">				
					<div class="table-responsive" style="border: 0px !important;" border="0">
						...
						<%	
							...
							try{
								ResultSet rs = stmtQry.executeQuery(selectDbDoorByHostByGroupUser("32", ses_per, ses_group_user, ses_control_reader));
								while(rs.next()){ 
									...
									if(rs.getString("status_no") == null){
										...
										txt_desc = displayTextAlert(rs.getString("status_no"), txt_time, lang, "32");	
									}  
									if(lang.equals("th")){				
