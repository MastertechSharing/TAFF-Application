...
<% 
	...
	session.setAttribute("subtitle", "report_302");
	session.setAttribute("action", "report_302.jsp?");
	...
	<%	}	%>	
		...
		<script>
			function show_detail(){
				view_detail.location = 'iframe_data.jsp?ac=event&ac_code=2';
			...
			function fncSubmit(lang, msg, msg2, msg3, msg4, cRow_door, cRow_section, supervisor){
				...
				if(document.form1.pagefile.value == "pdf"){		
					...
					document.form1.action = "report_302_excel.jsp";
				}
