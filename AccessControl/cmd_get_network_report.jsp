...
<%	
	...
	session.setAttribute("subtitle", "getnetwork");
	session.setAttribute("action", "cmd_get_network_report.jsp?");
...
<html lang="en">
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="min-width: 1360px; margin-top: -50px;" onLoad="sendRequest(); ShowCurrentTime(); updateClock();">
		...
		<div class="table-responsive" style="border: 0px !important; margin-bottom: -55px;" border="0">
			...
			<div style="overflow-y: auto; overflow-x: hidden; width: 1360px" border="0">
				<table style="min-width: 800px; margin-bottom: 0px;" class="table table-hover" align="center" id="table1" border="0">
					<thead>
						<td width="4%" align="center"> <b> <%= lb_no %> </b> </td>
						<td width="17%" align="center"> <b> <%= lb_doorcode %> </b> </td>
						<td width="25%" align="center"> <b> <%= lb_description %> </b> </td>
						<td width="10%" align="center"> <b> <%= lb_result %> </b> </td>
						<td width="9%" align="center"> <b> IP Address </b> </td>
						<td width="9%" align="center"> <b> Gateway </b> </td>
						<td width="9%" align="center"> <b> Subnet Mask </b> </td>
						<td width="9%" align="center"> <b> Host Address </b> </td>
						<td width="8%" align="center"> <b> Port </b> </td>
					</thead>
				</table>
			</div>
		</div>
