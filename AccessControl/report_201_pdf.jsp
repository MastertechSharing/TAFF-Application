...
<% 
	...
	session.setAttribute("action", "report_201_pdf.jsp?");
...
<html lang="en">
	<head>
		...
		<script>
			function orderBy(){
				document.form1.action = "report_201_pdf.jsp";
				document.getElementById("form1").submit();
			}
			function changePage(screen){
				document.form1.action = "report_201_pdf.jsp?screen="+screen+"&";
				document.getElementById("form1").submit();
			}
		</script>
...
<%	
	...
	if(date_time1.compareTo(date_time2) > 0){
		...
		if(check_employee){
			...
			sql = sql + "GROUP BY trs.idcard, trs.date_event, trs.reader_no, emp.th_fname, emp.th_sname, emp.en_fname, emp.en_sname, rd.th_desc, rd.en_desc, emp.sec_code, sec.th_desc, sec.en_desc ";
								...
								<div class="modal-title col-xs-12 col-md-12">
									...
									<div class="bs-callout bs-callout-info"> 
										<div class="row alert-message-info" style="height: 32px; margin-left: -10px; margin-top: -10px; margin-right: -10px;">
											<label class="col-xs-6 col-md-6 control-label" style="margin-top: 5px;"> <i class="glyphicon glyphicon-list-alt"> </i> &nbsp; <a href="report_201.jsp"> <%= lb_report_201 %> </a> </label>
									...
									%>
											...
											<div class="col-xs-2 col-md-2"> 
												<select class="form-control <%= selectpicker %>" data-width="100%" data-size="15" data-container="body" name="select_orderby" style="max-height: 28px !important; font-size: 12px !important;" onChange="orderBy()">
													...
													<option value="3" <% if(select_orderby.equals("3")){ %> selected <%}%>> <%= lb_readers %> </option>
												</select>
											</div>
