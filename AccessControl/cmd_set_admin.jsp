...
<% 
	...
	session.setAttribute("subtitle", "setadmin");
	session.setAttribute("action", "cmd_set_admin.jsp?");
			...
			<div class="container">
				...
				<form id="form1" name="form1" method="post">
							...
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								...
								<div class="row">	
									...
									<h5 class="modal-title col-xs-9 col-md-9">
										<select class="form-control selectpicker" data-width="10%" data-container="body" data-size="10" name="type_action" id="type_action">
											<option value="0"> <%= lb_del %> </option>
											<option value="1" selected> <%= lb_add %> </option>
										</select>		
									</h5>								
								</div>
							</div>
					...
					<div class="col-xs-12" align="center"> 
						...
						<input type="hidden" name="command" value="87">
