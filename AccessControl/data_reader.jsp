...
<% 
	...
	session.setAttribute("action", "data_reader.jsp?action="+getaction+"&");
...
<html lang="en">
	<head>
		...
		<script language="javascript">
			...
			function Load_DataTable(){
				$(document).ready(function() {
					$('#data_table').dataTable( {
						...
						"bServerSide": true,
						"bProcessing": true,
						"sAjaxSource": "data_reader_server_side.jsp",
			...
			function ModalConfirm(sCode, sText, th_name, en_name, door_desc){
				...
				document.getElementById("text_door").innerHTML = door_desc;
			...
			function Confirm_Button(){ 
				location.href = 'module/act_reader.jsp?action=del&reader_no='+document.getElementById('sCode').value;
			}
			
			function CheckConfig(countRD, config_reader, sText){
				...
				if(((config_int == 0) && (m_int < 4)) || ((config_int == 1) && (m_int < 8)) || ((config_int == 2) && (m_int < 10)) || (config_int == 3)){	
					location.href = 'edit_reader.jsp?action = add';
				}else{
				...
				<div class="table-responsive" style="border: 0px !important;" border="0">
					<div style="min-width: 1080px;" class="table" border="0">	
						...
						<table style="min-width: 1080px;" align="center" id="data_table" class="table table-striped table-bordered" cellspacing="0" >
							...
							<%	if(checkPermission(ses_per, "0")){	%>	
									...
									<td width="3%" align="center"> </td>
							<%	}	%>
									<td width="16%" align="center"> <%= lb_readerno %> </td>
									<td width="25%" align="center"> <%= lb_thdesc %> </td>
									<td width="25%" align="center"> <%= lb_endesc %> </td>
									<td width="28%" align="center"> <%= lb_doorcode %> </td>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class="col-xs-12" align="left" style="margin-left: -15px; min-width: 500px;">
						<div class="btn-group">
							...
							<%	if(checkPermission(ses_per, "0")){	%>	
							<button type="button" class="btn btn-primary btn-sm" onClick="Add_Data('edit_reader.jsp?action=add');"> 
							...
							<div class="col-xs-12 col-md-12" style="margin-bottom: 15px;">
								<strong>
									<div class="alert alert-warning" role="alert" style="min-width: 50px;">
										<div class="row">
											<div class="col-xs-5 col-md-5" align="right"> <%= lb_readerno %> :  </div>
										...
										<div class="row">
											...
											<div class="col-xs-7 col-md-7" align="left"> <p id="text_door" class="ellipsis_string" style="width: 95%"> </p> </div>
										</div>
									</div>
								</strong>
							</div>
