...
<% 
	...
	session.setAttribute("subtitle", "setfirmware");
	session.setAttribute("action", "cmd_set_firmware.jsp?");
	...
	<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
		...
		<div class="body-display">
			<div class="container">			
				...
				<%	if(sw_version.equals("67")){	%>
					<input type="hidden" name="rdo_reader" value="3" >	
				<%	}else{	%>
								...
								<div class="row">
									...
									<h5 class="modal-title col-xs-9 col-md-9" style="margin-top: 5px;"> 
										<div style="min-height: 29px;">
											...
											<input name="rdo_reader" type="radio" value="3" style="margin-left: 30px;"> &nbsp; Reader 1, 2
											<input name="rdo_reader" type="radio" value="4" style="margin-left: 30px;" checked> &nbsp; Main Unit
										</div>
									</h5>
								</div>
							</div>
