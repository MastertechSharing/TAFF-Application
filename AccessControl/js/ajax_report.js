...
function showReponseCommand(num,ip,door_id,door_desc,result,data){	
	if(request_Command=="22"){			//	Get Num ID Template
		...
		show_facegetinformation(num,ip,door_id,door_desc,result,data);
	}else if(request_Command=="F4"){	//	Face Get Employee List
		show_getcommand(num,ip,door_id,door_desc,result); 		
	}else if(request_Command=="F5"){	//	Face Get Employee
		show_facegetemployee(num,ip,door_id,door_desc,result,data);		
...
function show_facesetcommand(num,ip,door_id,desc,result,data){ 	
	var tbl = document.getElementById("table1");
	var tblBody = document.createElement("tbody");	
	var row = document.createElement("tr");      
...
function show_facegetinformation(num,ip,door_id,desc,result,data){
	var tbl = document.getElementById("table1");
	var tblBody = document.createElement("tbody");
	var row = document.createElement("tr");
...
function show_facegetemployee(num,ip,door_id,desc,result,data){
	var tbl = document.getElementById("table1");
	var tblBody = document.createElement("tbody");
	var row = document.createElement("tr");
	...
	if(capture_jpeg_base64 != "-" && capture_jpeg_base64 != null){		
		showPic = "View";		
		var linkpage = document.createElement('a');
...
function show_facesetemployees(num,ip,door_id,desc,result,data){		
	var tbl = document.getElementById("table1");
	var tblBody = document.createElement("tbody");
	var row = document.createElement("tr");
	...
	//if(result == "1") {
		if(Number(data) != 0){
			...
			linkpage.setAttribute('href', 'cmd_face_set_employees_data.jsp?'+checkModeData(ip, door_id)+'&');
			linkpage.onclick = openInNewWindow;
			linkpage.innerHTML = data;
			setstyleresult(cell5,4);
			cell5.appendChild(linkpage);
