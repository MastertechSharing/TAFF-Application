...
<%	
	...
	session.setAttribute("action", "cmd_get_idtable.jsp?");	
				...
				<form id="form1" name="form1" method="post">
					<div class="table-responsive" style="border: 0px !important; margin-top: -10px;" border="0">
						<div style="min-width: 800px;" class="table" border="0">
							...
							<%	if(sw_version.equals("67")){	%>
								<input type="hidden" name="typebio" id="finger_print" value="A">	
							<%	}else{	%>
								<p>
								<div class="row">
									...
									<h5 class="modal-title col-xs-9 col-md-9" style="margin-top: 5px;"> 
										<div style="min-height: 24px;">
											<input name="typebio" id="finger_print" type="radio" value="A" style="margin-left:  0px;"> &nbsp; Finger
											<input name="typebio" id="palm_vein" type="radio" value="B" style="margin-left: 30px;"> &nbsp; Palm
											<input name="typebio" id="all" type="radio" value="1" style="margin-left: 30px;" checked> &nbsp; <%= lb_all %>
										</div>
									</h5>
								</div>
							<%	}	%>
					...
					<div class="col-xs-4" align="center"> 
						...
						<% 	
							if(getModuleF(stmtQry).equals("0")){
								out.println("<input type='hidden' name='command' value='81'>");
							}else{
								out.println("<input type='hidden' name='command' value='45'>");
							}							
						%>
