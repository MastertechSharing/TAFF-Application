...
<% 
	...
	session.setAttribute("action", "edit_mapserial.jsp?"+"&action="+request.getParameter("action")+"&serial_no="+request.getParameter("serial_no")+"&");	
%>
		...
		<script language="javascript">
			...
			function change_class(field_name){
				if(field_name == 'serial_no'){
					if(document.form1.serial_no.value != ""){
						document.getElementById("textbox_serial_no").className = "form-group has-success has-feedback";
						document.getElementById("icon_serial_no").className = "glyphicon glyphicon-ok form-control-feedback";
					}else{
						document.getElementById("textbox_serial_no").className = "form-group has-error has-feedback";
						document.getElementById("icon_serial_no").className = "glyphicon glyphicon glyphicon-star form-control-feedback";
					}
				}
			}
		</script>
...
<% 
		...
		if(request.getParameter("action") != null){
			...
			response.sendRedirect("data_mapserial.jsp");
		}
...
<% 		if(action.equals("add")){	%>
						...
						<div class="row form-group">
							<label class="control-label label-text-1 col-md-2"> <%= lb_serial_no %> : </label>
							<div class="col-md-4">
								<div class="form-group has-error has-feedback" id="textbox_serial_no" style="margin-bottom: 0px">
									<input type="text" class="form-control" id="serial_no" name="serial_no" maxlength="20" placeholder="<%= lb_serial_no %>" onKeyPress="IsValidCharacter()" onKeyUp="change_class('serial_no');" onBlur="change_class('serial_no');">
									<span class="glyphicon glyphicon-star form-control-feedback" id="icon_serial_no" aria-hidden="true"> </span>
								</div>
							</div>
							<div class="col-md-6" style="margin-top: 6px;"> </div>
						</div>
						<div class="row form-group">
							<label class="control-label label-text-1 col-md-2"> <%= lb_doorcode %> : </label>
							<div class="col-md-4">
								<div class="form-group has-error has-feedback" id="textbox_serial_no" style="margin-bottom: 0px">
									<input type="text" class="form-control" id="taff_id" name="taff_id" maxlength="4" placeholder="<%= lb_doorcode %>" onKeyPress="IsValidCharacter()" onKeyUp="change_class('taff_id');" onBlur="change_class('taff_id');">
									<span class="glyphicon glyphicon-star form-control-feedback" id="icon_serial_no" aria-hidden="true"> </span>
								</div>
							</div>
							<div class="col-md-6" style="margin-top: 6px;"> </div>
						...
						<div class="row form-group" style="margin-bottom: 0px;">
							<div class="col-md-12" align="center"> 
								<input type="button" class="btn btn-primary btn-sm button-shadow1 button-shadow2" id="btnok" value=" &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; " onClick="return Confirm_add_edit(document.form1.serial_no, '<%= msg_confirmedit %>', '<%= msg_notinput_pos %>', 'module/act_mapserial.jsp?action=add', 'add');"> &nbsp; 
								<input type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" value=" &nbsp; &nbsp; &nbsp; <%= btn_cancel %> &nbsp; &nbsp; &nbsp; " onClick="location.href='data_mapserial.jsp'">
							</div>
						</div> 
...
%>
				...
				<div class="row form-group">
					<label class="control-label label-text-1 col-md-2"> <%= lb_serial_no %> : </label>
					<div class="col-md-4">
						<div class="form-group has-success has-feedback" id="textbox_serial_no" style="margin-bottom: 0px">
							<input type="text" class="form-control" id="serial_no" name="serial_no" value="<%= serial_no %>" maxlength="20" placeholder="<%= serial_no %>" onKeyPress="IsValidCharacter()" onKeyUp="change_class('serial_no');" onBlur="change_class('serial_no');">
							<span class="glyphicon glyphicon-ok form-control-feedback" id="icon_serial_no" aria-hidden="true"> </span>
							<input type="hidden" name="serial_no2" id="serial_no2" value="<%= serial_no %>">
						</div>
					</div>
					<div class="col-md-6" style="margin-top: 6px;"> </div>
				</div>
				<div class="row form-group">
					...
					<div class="col-md-4">
						<div class="form-group has-error has-feedback" id="textbox_serial_no" style="margin-bottom: 0px">
							<input type="text" class="form-control" id="taff_id" name="taff_id" value="<%= rs.getString("taff_id") %>" maxlength="4" placeholder="<%= lb_doorcode %>" onKeyPress="IsValidCharacter()" onKeyUp="change_class('taff_id');" onBlur="change_class('taff_id');">
							<span class="glyphicon glyphicon-star form-control-feedback" id="icon_serial_no" aria-hidden="true"> </span>
						</div>
					</div>
					<div class="col-md-6" style="margin-top: 6px;"> </div>
				...
				<div class="row form-group" style="margin-bottom: 0px;">
					<div class="col-md-12" align="center"> 
						<input type="button" class="btn btn-primary btn-sm button-shadow1 button-shadow2" id="btnok" value=" &nbsp; &nbsp; &nbsp; <%= btn_ok %> &nbsp; &nbsp; &nbsp; " onClick="return Confirm_add_edit(document.form1.serial_no, '<%= msg_confirmedit %>', '<%= msg_notinput_pos %>', 'module/act_mapserial.jsp?action=edit', 'edit');"> &nbsp; 
						<input type="button" class="btn btn-default btn-sm button-shadow1 button-shadow2" value=" &nbsp; &nbsp; &nbsp; <%= btn_cancel %> &nbsp; &nbsp; &nbsp; " onClick="location.href='data_mapserial.jsp'">
					</div>
				</div> 						
<%			}	
