...
<% 
	...
	session.setAttribute("subtitle", "cleartemplate");
	session.setAttribute("action", "cmd_clear_template.jsp?");
			...
			function onSubmitGetSet(data_selected, lang, msg, msg2){
				if("<%= numtaff %>" == 0){
					...
					if(data_selected == ""){
						...
						if(lang == 'th'){
							document.getElementById('text_confirm').innerHTML = "ยืนยันการเคลียร์ข้อมูล";
						}else{
							document.getElementById('text_confirm').innerHTML = "Confirm clear data.";
						}
