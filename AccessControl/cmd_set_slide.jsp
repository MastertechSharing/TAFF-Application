...
<%	
	...
	session.setAttribute("subtitle", "setslide");
	session.setAttribute("action", "cmd_set_slide.jsp?");
			...
			<div class="container">
							...
							<div class="bs-callout bs-callout-info" style="margin-left: 5px; margin-right: 5px;"> 
								<div class="row">
									...
									<div class="modal-title col-xs-6 col-md-6" style="margin-top: 6px;"> 
										<input type="file" name="files" id="files" class="filestyle" data-buttonBefore="true" data-buttonText="&nbsp; Choose File .jpg" data-buttonName="btn-primary" data-size="xs" onChange="checkInputFile('<%= lb_msg_jpg %>')" accept="image/jpeg">
									</div>
								...
								<div class="row">
									...
									<div class="modal-title col-xs-9 col-md-9"> <font color="red"> *** <%= lb_msg_jpg %> </font> </div>
								</div>
							</div>
						</div>
					</div>
				...
				<form id="form1" name="form1" method="post">
					...
					<div class="col-xs-4" align="center"> 
						...
						<input type="hidden" name="command" value="65">
