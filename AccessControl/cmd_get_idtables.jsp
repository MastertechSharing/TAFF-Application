...
<%	
	...
	session.setAttribute("action", "cmd_get_idtables.jsp?");	
					...
					<div class="col-xs-4" align="center"> 
						...
						<% 	
							if(getModuleF(stmtQry).equals("0")){
								out.println("<input type='hidden' name='command' value='A1'>");
							}else{
								out.println("<input type='hidden' name='command' value='48'>");
							}
						%>
