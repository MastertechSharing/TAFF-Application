...
%>
		<div class="bodycontainer scrollable" style="overflow-x: hidden; overflow-y: auto;">
			<div class="row">
				<h5 class="modal-title <%= col1 %>" > <div align="right"> <b> <%= lb_duty_in %> : </b> </div> </h5>
				<h5 class="modal-title <%= col2 %>" > <%= duty_in %> </h5>
			</div>
			<%= set_hr %>
			<div class="row">
				<h5 class="modal-title <%= col1 %>" > <div align="right"> <b> <%= lb_duty_out %> : </b> </div> </h5>
				<h5 class="modal-title <%= col2 %>" > <%= rs.getString("duty_out") %> </h5>
			</div>
			<%= set_hr %>
			<div class="row">
